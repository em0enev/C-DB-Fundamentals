    ...
    class StartUp
    {
        static void Main(string[] args)
        {
            ...
            using (connection)
            {
                ...
                string tableEvilnesFactor = @"CREATE TABLE EvilnessFactors(Id INT PRIMARY KEY IDENTITY, Name VARCHAR(50))";
                ...
                ExecuteNonQuery(connection, tableEvilnesFactor);
                ...
                string insertEvilnesFactor = @"INSERT INTO EvilnessFactors (Name) VALUES ('Super good'),('Good'),('Bad'), ('Evil'),('Super evil')";
                ...
                ExecuteNonQuery(connection, insertEvilnesFactor);
        ...
        private static void ExecuteNonQuery(SqlConnection connection, string queryForExecute)
        {
            using (SqlCommand command = new SqlCommand(queryForExecute, connection))
            {
